...
with open(os.path.join(pasture_dir, 'Main.lua'), 'r', encoding='utf-8') as f:
    main_src = f.read()
...
with open('lua_update.lua', 'w', encoding='utf-8') as f:
    f.write(lua_code)

print("Generated lua_update.lua")
